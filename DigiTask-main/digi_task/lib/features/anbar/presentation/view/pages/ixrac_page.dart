...
class IxracPage extends StatefulWidget {
  const IxracPage({super.key});

  @override
  State<IxracPage> createState() => _IxracPageState();
}

class _IxracPageState extends State<IxracPage> {
  final Dio _dio = Dio();

  Future<List<dynamic>> _fetchData() async {
    final response = await _dio.get('http://135.181.42.192/services/history/');
